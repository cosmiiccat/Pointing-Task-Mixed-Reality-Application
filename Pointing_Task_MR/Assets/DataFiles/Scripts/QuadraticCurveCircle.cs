...
public class QuadraticCurveCircle : MonoBehaviour
{
    ...
    void AddPointToLineRenderer(float angle, int index)
    {
        ...
        StartCoroutine(PostRequest("http://" + IP_Address + ":5000/parabola", sendPos.x.ToString("f5") + "," + sendPos.y.ToString("f5") + "," + sendPos.z.ToString("f5") + "," + QR_Position.ToString("f5") + "," + anchorPos.ToString("f5") + "," + sendPos.ToString("f5") + "," + "Circle"));
